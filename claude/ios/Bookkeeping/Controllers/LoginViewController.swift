...
class LoginViewController: UIViewController {
    ...
    private let usernameField = UIFactory.textField(placeholder: "请输入用户名")
    private let usernameError = UIFactory.errorLabel()

    private let passwordLabel = UIFactory.fieldLabel("密码")
    private let passwordField = UIFactory.textField(placeholder: "请输入密码", isSecure: true)
    ...
    private let loginButton = UIFactory.primaryButton(title: "登录")
    private let goRegisterButton = UIFactory.linkButton(title: "没有账号？去注册")
    ...
    private func setupUI() {
        ...
        goRegisterButton.contentHorizontalAlignment = .center

        // apiErrorLabel 内边距通过约束实现
